      ...
      <div className="flex flex-col gap-6 card py-14 px-10">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-6 mt-4 form">
            ...
            {!isSignIn && (
              <FormField control={form.control} name="password" label="Password" placeholder="Create New Password" />
            )}
            {!isSignIn && (
              <FormField control={form.control} name="password" label="Password" placeholder="Confirm Password" />
            )}
